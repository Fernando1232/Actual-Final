...
if(typeof jvxObjectList == "undefined"){
	var jvxObjectList = ["jvx_5b50bc951fc83"];
}else{
	jvxObjectList.push("jvx_5b50bc951fc83");
}
    ...
    try{
        ...
        if(cScrNode == undefined){
            ...
            for(var i=0;i<scrNodes.length;i++){
                ...
                if(scrSrc &&  scrSrc.indexOf("https://as.jivox.com/unit/unit_renderer.php?creativeUnitType=22&bDim=300x600&bUnitId=2200&siteId=25aba9801a0f01&campaignId=119189&es_pId=5sYhcJ&isDynamic=1&jvxVer=2&cMacro=https://googleads.g.doubleclick.net/dbm/clk%3Fsa%3DL%26ai%3DCOdttmwJQW7fVJNHriQOTh7LwDeus-M1SzPbIotcGsqf9_4YNEAEgg_3mH2DJltGGgICgGcgBCagDAaoEwQFP0PeXX6IezS8pASn5zVDVblHADzInIi4SRiU5VzWpvpNKL33VANIwdW8fkC0mwJFJLKitKZSibo5M2uu1vq0XrEzprMjDNy6_oawCuyo1u_lAt2aH7U7VmfvIGNrUoWhSU5LOnKy-2-WMiBi3In8ZfN0H1Tv5-yf6vaOn4fXhxrEQJelsekCHqIHB0cAFh9VCWVai0YAQWKPs1YzFkTJhfzmHXJy7judZ2u3Y7J7Mrz_0YzxgL4sgCEoYIjPfe0ZC4AQDkAYBoAZNgAf_zfhjqAeOzhuoB9XJG6gH2csbqAfPzBuoB6a-G6gHmM4b2AcA0ggHCIBhEAEYAPIIDmJpZGRlci10cnVzdHhfgAoEsBO-w_kE0BMA2BMD%26num%3D1%26cid%3DCAASEuRoSvDDeOhCHC9UI_9Fpge6ZA%26sig%3DAOD64_1Xd1_xtSNAfV8atf0RVK3C8VogrQ%26client%3Dca-pub-7350897138099958%26dbm_c%3DAKAmf-B7hlW_I_SYjNgjLNo5gwA4gzP1tPIU7uflYZaMz2I2_XZKog4W9rAturxWdR5DnHD-j63W%26dbm_d%3DAKAmf-AQJJp4XfnPWRGa7xNWSMWfv41em7aYOnV-i3OpfSNzFYnXYj2TlJ7Z0wrxvS0_CPnwMKjKfaqQ9-RJzoib_Sns5f-kf5_E56NgL6mAXfxAez64WgOaCzfmw0xwLv56oEAEiNfWi9BHjEhrzozXrQNPoQGb1Yx31NhRhmaI5Lh6Ysp90ugO6XyPeL5k-jqIEhTVwQCd49FlBzFI84M3VbFNRJJVfHFIwQp6MMCb_ESZn-5WtGc1163hkSeGpEJBXjrbbCjY7N_A_TmvbCWV9AaADtCAXnkHzKhjZEq-em9dFfO78cLO2oqUEYkI1KqA5GN-Z1oz-S35gKGpdjs1UdsoAjNAybiwc81v9OeNx7gKTeZTCP7KRKnXKmw9chgqkC-e-HSlSCH8s12cOVcgPhKeuOW70K0pm8RVq2hKRfRLnJ3qSIHVKiS0hmh2G7BM8iWTpH-E8DQ_8Xy9YQft-RJPCD8YQYzb69-sCgF0rf-SaU0cArJwURe_hRbM24a1b_HZ-xDF5xOZHSZocRneTHCwFsvPxw%26adurl%3D&r=1531970203600759") != -1){
                    cScrNode = scrNodes[i];
                }
            }
        }   
...
function createiFrameNode(obj){
	...
	if(document.body == null){
		document.write("<div id='jvxSkeletonRef_5b50bc951fc83' style='display:none;'></div>")
	}
			...
			createImprTrackerFrame = function(frameId){
				...
				function jvx_5b50bc951fc83fireImprTracker(url, elType){
			var elNode = null;
			if(elType == 'script'){
							} else {
...
finalURL = replaceCacheBuster4;				//finalURL = replaceCacheBuster;
			...
			if(elType == 'script'){
														imprScrTrackerCnt++;
					var imprFrameId = 'jvx_5b50bc951fc83ImprTrackerFrame_'+imprScrTrackerCnt;
			...
			function jvx_5b50bc951fc83fireIT(){
										jvx_5b50bc951fc83fireImprTracker('https://tag.researchnow.com/t/beacon?adn=1&ca=20731263&cr=98021903&pl=214739440&pr=12119&si=2404124', 'img');
																																		jvx_5b50bc951fc83fireImprTracker('https://secure-gl.imrworldwide.com/cgi-bin/m?ca=nlsn110058&cr=98021903&ce=cadreon&pc=214739440&ci=nlsnci1033&am=3&at=view&rt=banner&st=image&r=1532019746', 'img');
																																}
		
		jvx_5b50bc951fc83fireIT();
		
	/*
JavaScript responsible for frame busting
*/
var jvx_5b50bc951fc83TraffickedInFrame = false,			// COM: should be true, if !busted and self != top
	jvx_5b50bc951fc83SafeFrameSupported = false,		// COM: should be true only when safeFrame is supported in the page
	jvx_5b50bc951fc83CanBustFromFrame = true,			// COM: should be false, when all busting method fails
	jvx_5b50bc951fc83InNestedFrame = false;				// COM: should be true, when tag trafficked inside nested frame

if(self != top){
	jvx_5b50bc951fc83TraffickedInFrame = true;
}

try{
		$sf.ext.register(300, 600);
		jvx_5b50bc951fc83SafeFrameSupported = true;
}catch(e){
	jvx_5b50bc951fc83SafeFrameSupported = false;
}
...
var CreativeUnit = (function(){
	...
	function receiveHtml5Message(e){
        ...
        var s = e.data.split(':', 10);
		        if(s && s.length >= 2 && s[0] == 'jvx_5b50bc951fc83'){
			var msg = s[1];
			if(msg == 'openExpansion'){
									jvx_5b50bc951fc83.openClickThrough();
							} else if(msg == 'closeExpansion'){
				jvx_5b50bc951fc83.closeExpansion(false, false);
			} else if(msg == 'expansionLoaded'){
							} else if(msg == 'recordUIR'){
				jvx_5b50bc951fc83.UIRRecorded = true;
			} else if(msg == 'lastMouseLeave'){
				jvx_5b50bc951fc83.lastMLeaveId = s[2];
			} else if(msg == 'clearUIR'){
				clearTimeout(jvx_5b50bc951fc83.UIRTimer);
			} else if(msg == 'recordDwell'){
				if(!jvx_5b50bc951fc83.DwellRecorded){
					jvx_5b50bc951fc83.recordDwellEvent(49, jvx_5b50bc951fc83.DwellElapsedTime);
				}
			}
									else if(msg=="dynamicProperties") {
                jvx_5b50bc951fc83.updateDYProperties(s[2],1);
			}
														}
	}
	...
	function postHtml5Message(winRef, msg){
		try{
			winRef.postMessage('jvx_5b50bc951fc83' + ':' + msg, "*");
		}catch(e){
			if(typeof(winRef.contentWindow) != 'undefined')
				winRef.contentWindow.postMessage('jvx_5b50bc951fc83' + ':' + msg, "*");
		}
	}
	...
	*/
	...
	function clearNode(pNode, idPrefix){
		...
		var currPageURL = "";
				try {
			if(jvx_5b50bc951fc83TraffickedInFrame){
...
finalURL = replaceCacheBuster4;			//finalURL = replaceCacheBuster;
			...
			if(url.indexOf("?") == -1){
				...
				finalURL = url + "&r=" + Math.random();
					...
					if(typeof jvx_5b50bc951fc83 != 'undefined'){
				finalURL += "&es_cgName_"+jvx_5b50bc951fc83.DYReportingKey;
                if(jvx_5b50bc951fc83.DYSegmentName != ""){
                    finalURL += "&es_segName_"+jvx_5b50bc951fc83.DYSegmentName;
                }
			}
				imgEl.src = finalURL;
			}       
	...
	function setOpacity(myElement, opacityValue) {
		...
		var cLeft = sfLeft + "px",
			cTop = sfTop + "px",
			cNode = getElById(jvx_5b50bc951fc83.adUnitContainerId);
		addStyles(cNode, {"left":cLeft, "top":cTop});
	}
	function renderAdInsideSafeFrame(animDir){
		if(jvx_5b50bc951fc83SafeFrameSupported){
			/* ------------- SafeFrame Settings--------------- */
						var ref = jvx_5b50bc951fc83,
	 ...
	 /* var rect = obj.getBoundingClientRect();
		...
		var vpStyles = findPos(getElById(jvx_5b50bc951fc83.adUnitContainerId)),
			vpTop = "", vpLeft = "";
	...
	function mraidHandleOnViewable(viewable){
		jvxMraidIsShown = viewable;		 
			if(!jvxMraidIsShown || getElById(jvx_5b50bc951fc83.baseContainerId)){
				return; 
			}
		jvx_5b50bc951fc83.init();		
		}
	...
	function CreativeUnit(uniqId){
	    ...
	    this.id = uniqId;  
		this.playerParamsMap = {"reportingURL":"https:\/\/evs.jivox.com","creativeUnitType":"22","bDim":"300x600","bUnitId":"2200","siteId":"25aba9801a0f01","campaignId":"119189","es_pId":"5sYhcJ","isDynamic":"1","jvxVer":"2","cMacro":"https:\/\/googleads.g.doubleclick.net\/dbm\/clk?sa=L&ai=COdttmwJQW7fVJNHriQOTh7LwDeus-M1SzPbIotcGsqf9_4YNEAEgg_3mH2DJltGGgICgGcgBCagDAaoEwQFP0PeXX6IezS8pASn5zVDVblHADzInIi4SRiU5VzWpvpNKL33VANIwdW8fkC0mwJFJLKitKZSibo5M2uu1vq0XrEzprMjDNy6_oawCuyo1u_lAt2aH7U7VmfvIGNrUoWhSU5LOnKy-2-WMiBi3In8ZfN0H1Tv5-yf6vaOn4fXhxrEQJelsekCHqIHB0cAFh9VCWVai0YAQWKPs1YzFkTJhfzmHXJy7judZ2u3Y7J7Mrz_0YzxgL4sgCEoYIjPfe0ZC4AQDkAYBoAZNgAf_zfhjqAeOzhuoB9XJG6gH2csbqAfPzBuoB6a-G6gHmM4b2AcA0ggHCIBhEAEYAPIIDmJpZGRlci10cnVzdHhfgAoEsBO-w_kE0BMA2BMD&num=1&cid=CAASEuRoSvDDeOhCHC9UI_9Fpge6ZA&sig=AOD64_1Xd1_xtSNAfV8atf0RVK3C8VogrQ&client=ca-pub-7350897138099958&dbm_c=AKAmf-B7hlW_I_SYjNgjLNo5gwA4gzP1tPIU7uflYZaMz2I2_XZKog4W9rAturxWdR5DnHD-j63W&dbm_d=AKAmf-AQJJp4XfnPWRGa7xNWSMWfv41em7aYOnV-i3OpfSNzFYnXYj2TlJ7Z0wrxvS0_CPnwMKjKfaqQ9-RJzoib_Sns5f-kf5_E56NgL6mAXfxAez64WgOaCzfmw0xwLv56oEAEiNfWi9BHjEhrzozXrQNPoQGb1Yx31NhRhmaI5Lh6Ysp90ugO6XyPeL5k-jqIEhTVwQCd49FlBzFI84M3VbFNRJJVfHFIwQp6MMCb_ESZn-5WtGc1163hkSeGpEJBXjrbbCjY7N_A_TmvbCWV9AaADtCAXnkHzKhjZEq-em9dFfO78cLO2oqUEYkI1KqA5GN-Z1oz-S35gKGpdjs1UdsoAjNAybiwc81v9OeNx7gKTeZTCP7KRKnXKmw9chgqkC-e-HSlSCH8s12cOVcgPhKeuOW70K0pm8RVq2hKRfRLnJ3qSIHVKiS0hmh2G7BM8iWTpH-E8DQ_8Xy9YQft-RJPCD8YQYzb69-sCgF0rf-SaU0cArJwURe_hRbM24a1b_HZ-xDF5xOZHSZocRneTHCwFsvPxw&adurl=","r":"1531970203600759","0":"","serverURL":"https:\/\/as.jivox.com"};
		
		this.campaignId = '119189';
		this.siteId = '25aba9801a0f01';
		this.placementId = '5sYhcJ';
		...
		this.baseURL = 'https://as.jivox.com/unit/layout_renderer.php?creativeUnitType=22&bDim=300x600&bUnitId=2200&siteId=25aba9801a0f01&campaignId=119189&es_pId=5sYhcJ&isDynamic=1&jvxVer=2&cMacro=https%3A%2F%2Fgoogleads.g.doubleclick.net%2Fdbm%2Fclk%3Fsa%3DL%26ai%3DCOdttmwJQW7fVJNHriQOTh7LwDeus-M1SzPbIotcGsqf9_4YNEAEgg_3mH2DJltGGgICgGcgBCagDAaoEwQFP0PeXX6IezS8pASn5zVDVblHADzInIi4SRiU5VzWpvpNKL33VANIwdW8fkC0mwJFJLKitKZSibo5M2uu1vq0XrEzprMjDNy6_oawCuyo1u_lAt2aH7U7VmfvIGNrUoWhSU5LOnKy-2-WMiBi3In8ZfN0H1Tv5-yf6vaOn4fXhxrEQJelsekCHqIHB0cAFh9VCWVai0YAQWKPs1YzFkTJhfzmHXJy7judZ2u3Y7J7Mrz_0YzxgL4sgCEoYIjPfe0ZC4AQDkAYBoAZNgAf_zfhjqAeOzhuoB9XJG6gH2csbqAfPzBuoB6a-G6gHmM4b2AcA0ggHCIBhEAEYAPIIDmJpZGRlci10cnVzdHhfgAoEsBO-w_kE0BMA2BMD%26num%3D1%26cid%3DCAASEuRoSvDDeOhCHC9UI_9Fpge6ZA%26sig%3DAOD64_1Xd1_xtSNAfV8atf0RVK3C8VogrQ%26client%3Dca-pub-7350897138099958%26dbm_c%3DAKAmf-B7hlW_I_SYjNgjLNo5gwA4gzP1tPIU7uflYZaMz2I2_XZKog4W9rAturxWdR5DnHD-j63W%26dbm_d%3DAKAmf-AQJJp4XfnPWRGa7xNWSMWfv41em7aYOnV-i3OpfSNzFYnXYj2TlJ7Z0wrxvS0_CPnwMKjKfaqQ9-RJzoib_Sns5f-kf5_E56NgL6mAXfxAez64WgOaCzfmw0xwLv56oEAEiNfWi9BHjEhrzozXrQNPoQGb1Yx31NhRhmaI5Lh6Ysp90ugO6XyPeL5k-jqIEhTVwQCd49FlBzFI84M3VbFNRJJVfHFIwQp6MMCb_ESZn-5WtGc1163hkSeGpEJBXjrbbCjY7N_A_TmvbCWV9AaADtCAXnkHzKhjZEq-em9dFfO78cLO2oqUEYkI1KqA5GN-Z1oz-S35gKGpdjs1UdsoAjNAybiwc81v9OeNx7gKTeZTCP7KRKnXKmw9chgqkC-e-HSlSCH8s12cOVcgPhKeuOW70K0pm8RVq2hKRfRLnJ3qSIHVKiS0hmh2G7BM8iWTpH-E8DQ_8Xy9YQft-RJPCD8YQYzb69-sCgF0rf-SaU0cArJwURe_hRbM24a1b_HZ-xDF5xOZHSZocRneTHCwFsvPxw%26adurl%3D&r=1531970203600759&objectName=jvx_5b50bc951fc83&adUnitId=2200&jvxSessionId=1532017813.9528';
        		this.baseURL += '&base=1';
		...
		this.browserName = 'Chrome';
											...
											fireTracker("https://sync.jivox.com/tags/sync/usync.php?src=tag&campaignId=119189&siteId=25aba9801a0f01&es_pId=5sYhcJ&px=1qZZF6qG&r=1532017813");
	...
	CreativeUnit.prototype = {
		constructor:CreativeUnit,
         ...
         sendCookieRequest: function(cookieName){
	        if(jvx_5b50bc951fc83SafeFrameSupported){
		         var callBackFnName ='jvx_5b50bc951fc83'+".updateDYProperties";
		         jvx_5b50bc951fc83.addScriptTagToBody('https://as.jivox.com'+"/unit/getCookies.php?cookieName="+cookieName+"&callback="+callBackFnName+"&deleteCookie="+1+"&r_="+Math.random());  
	         }                  
         },
         updateDYProperties: function(val,isNotCookieData){
            ...
            jvx_5b50bc951fc83.DYReportingKey = dynPropArr[0] ? decodeURIComponent(dynPropArr[0]) : "";
            jvx_5b50bc951fc83.DYSegmentName = dynPropArr[1] ? decodeURIComponent(dynPropArr[1]) : "";
            //this.fireCREvent();
         },
                    ...
                    if(jvx_5b50bc951fc83SafeFrameSupported){
                        var getReportingKeyFromCookie = false,
                            ...
                            if(getReportingKeyFromCookie){
                                jvx_5b50bc951fc83.sendCookieRequest('jvx_5b50bc951fc83'+"_dynamicProperties");
                            }
                    }
                											}	
		},
			...
			var executeCallBack = function(transitionEvt){
					...
					if(ref.expansionOpen){
						...
						if(ref.openExpAgain) ref.openExpAgain = false; 
												...
												if(jvx_5b50bc951fc83SafeFrameSupported && transitionEvt){
							try{
								$sf.ext.collapse();
															}catch(e){}
						}
		...
		getIBusterFrameInfo:function(){
			if(typeof(jivoxIBusterAdObject) != "undefined"){
				...
				for(var i=0; i < iFramesLen; i++){
					if(hostIframes[i].contentWindow == jivoxIBusterAdObject["jvx_5b50bc951fc83"].foreignWindow){
...
//				e2Node.style.margin = mt + ' 0 0 ' + ml;
		...
		openClickThrough:function(){
						window.open('https://googleads.g.doubleclick.net/dbm/clk?sa=L&ai=COdttmwJQW7fVJNHriQOTh7LwDeus-M1SzPbIotcGsqf9_4YNEAEgg_3mH2DJltGGgICgGcgBCagDAaoEwQFP0PeXX6IezS8pASn5zVDVblHADzInIi4SRiU5VzWpvpNKL33VANIwdW8fkC0mwJFJLKitKZSibo5M2uu1vq0XrEzprMjDNy6_oawCuyo1u_lAt2aH7U7VmfvIGNrUoWhSU5LOnKy-2-WMiBi3In8ZfN0H1Tv5-yf6vaOn4fXhxrEQJelsekCHqIHB0cAFh9VCWVai0YAQWKPs1YzFkTJhfzmHXJy7judZ2u3Y7J7Mrz_0YzxgL4sgCEoYIjPfe0ZC4AQDkAYBoAZNgAf_zfhjqAeOzhuoB9XJG6gH2csbqAfPzBuoB6a-G6gHmM4b2AcA0ggHCIBhEAEYAPIIDmJpZGRlci10cnVzdHhfgAoEsBO-w_kE0BMA2BMD&num=1&cid=CAASEuRoSvDDeOhCHC9UI_9Fpge6ZA&sig=AOD64_1Xd1_xtSNAfV8atf0RVK3C8VogrQ&client=ca-pub-7350897138099958&dbm_c=AKAmf-B7hlW_I_SYjNgjLNo5gwA4gzP1tPIU7uflYZaMz2I2_XZKog4W9rAturxWdR5DnHD-j63W&dbm_d=AKAmf-AQJJp4XfnPWRGa7xNWSMWfv41em7aYOnV-i3OpfSNzFYnXYj2TlJ7Z0wrxvS0_CPnwMKjKfaqQ9-RJzoib_Sns5f-kf5_E56NgL6mAXfxAez64WgOaCzfmw0xwLv56oEAEiNfWi9BHjEhrzozXrQNPoQGb1Yx31NhRhmaI5Lh6Ysp90ugO6XyPeL5k-jqIEhTVwQCd49FlBzFI84M3VbFNRJJVfHFIwQp6MMCb_ESZn-5WtGc1163hkSeGpEJBXjrbbCjY7N_A_TmvbCWV9AaADtCAXnkHzKhjZEq-em9dFfO78cLO2oqUEYkI1KqA5GN-Z1oz-S35gKGpdjs1UdsoAjNAybiwc81v9OeNx7gKTeZTCP7KRKnXKmw9chgqkC-e-HSlSCH8s12cOVcgPhKeuOW70K0pm8RVq2hKRfRLnJ3qSIHVKiS0hmh2G7BM8iWTpH-E8DQ_8Xy9YQft-RJPCD8YQYzb69-sCgF0rf-SaU0cArJwURe_hRbM24a1b_HZ-xDF5xOZHSZocRneTHCwFsvPxw&adurl=https%3A%2F%2Fwww.lactaid.com%2Flactaid-difference%2Fwhy-choose-lactaid%3Futm_medium%3Ddisplay-html5%26site%3D0%261x1%3D%25epid%21%26200k%3D2018lactaiddairydesktop%26cadreonteam%3Dus_lactaid_2018lactaid');
				...
				openExpansion:function(autoExpand, skipOpenEvent){
						...
						if(!jvx_5b50bc951fc83CanBustFromFrame || jvx_5b50bc951fc83InNestedFrame){
				return;
			}
		...
		recordEvent:function(eventId,addnlParams){
				...
				var imgEl = document.createElement("img");
                var tempURL = "";
                var eventReportingURL = "https://evs.jivox.com/trk" + "/" + eventId + "/" + "119189/25aba9801a0f01/22/jvxSId_1532017813.9528";
                eventReportingURL += "/es_pId_5sYhcJ";
                tempURL += "";
                                tempURL += "";
                                tempURL = addnlParams ? (tempURL + "/" + addnlParams) : tempURL;
				tempURL = tempURL + "/jvxRandom_" + rand;
				//eventReportingURL = (eventId == 1) ? (eventReportingURL + ";https://googleads.g.doubleclick.net/dbm/clk?sa=L&ai=COdttmwJQW7fVJNHriQOTh7LwDeus-M1SzPbIotcGsqf9_4YNEAEgg_3mH2DJltGGgICgGcgBCagDAaoEwQFP0PeXX6IezS8pASn5zVDVblHADzInIi4SRiU5VzWpvpNKL33VANIwdW8fkC0mwJFJLKitKZSibo5M2uu1vq0XrEzprMjDNy6_oawCuyo1u_lAt2aH7U7VmfvIGNrUoWhSU5LOnKy-2-WMiBi3In8ZfN0H1Tv5-yf6vaOn4fXhxrEQJelsekCHqIHB0cAFh9VCWVai0YAQWKPs1YzFkTJhfzmHXJy7judZ2u3Y7J7Mrz_0YzxgL4sgCEoYIjPfe0ZC4AQDkAYBoAZNgAf_zfhjqAeOzhuoB9XJG6gH2csbqAfPzBuoB6a-G6gHmM4b2AcA0ggHCIBhEAEYAPIIDmJpZGRlci10cnVzdHhfgAoEsBO-w_kE0BMA2BMD&num=1&cid=CAASEuRoSvDDeOhCHC9UI_9Fpge6ZA&sig=AOD64_1Xd1_xtSNAfV8atf0RVK3C8VogrQ&client=ca-pub-7350897138099958&dbm_c=AKAmf-B7hlW_I_SYjNgjLNo5gwA4gzP1tPIU7uflYZaMz2I2_XZKog4W9rAturxWdR5DnHD-j63W&dbm_d=AKAmf-AQJJp4XfnPWRGa7xNWSMWfv41em7aYOnV-i3OpfSNzFYnXYj2TlJ7Z0wrxvS0_CPnwMKjKfaqQ9-RJzoib_Sns5f-kf5_E56NgL6mAXfxAez64WgOaCzfmw0xwLv56oEAEiNfWi9BHjEhrzozXrQNPoQGb1Yx31NhRhmaI5Lh6Ysp90ugO6XyPeL5k-jqIEhTVwQCd49FlBzFI84M3VbFNRJJVfHFIwQp6MMCb_ESZn-5WtGc1163hkSeGpEJBXjrbbCjY7N_A_TmvbCWV9AaADtCAXnkHzKhjZEq-em9dFfO78cLO2oqUEYkI1KqA5GN-Z1oz-S35gKGpdjs1UdsoAjNAybiwc81v9OeNx7gKTeZTCP7KRKnXKmw9chgqkC-e-HSlSCH8s12cOVcgPhKeuOW70K0pm8RVq2hKRfRLnJ3qSIHVKiS0hmh2G7BM8iWTpH-E8DQ_8Xy9YQft-RJPCD8YQYzb69-sCgF0rf-SaU0cArJwURe_hRbM24a1b_HZ-xDF5xOZHSZocRneTHCwFsvPxw&adurl=https%3A%2F%2Fwww.lactaid.com%2Flactaid-difference%2Fwhy-choose-lactaid%3Futm_medium%3Ddisplay-html5%26site%3D0%261x1%3D%25epid%21%26200k%3D2018lactaiddairydesktop%26cadreonteam%3Dus_lactaid_2018lactaid") : eventReportingURL;
									tempURL += "/es_cgName_"+jvx_5b50bc951fc83.DYReportingKey;
                    if(jvx_5b50bc951fc83.DYSegmentName != ""){
                        tempURL += "/es_segName_"+jvx_5b50bc951fc83.DYSegmentName;
                    }
		...
		recordDwellEvent:function(eventId, elapsedTime){
			...
			this.DwellTimer = null;
						...
						var cNode = createDivNode(this.adUnitContainerId);
			            												document.write('<div id="jvxScrRefNode_5b50bc951fc83" style="display:none;"></div>');	
				var jvxPNode = '';
				var jvxNode = getElById("jvxScrRefNode_5b50bc951fc83");
			...
			if(bestFitBase) {
				...
				if(this.baseHasLayout == 1) {
					this.baseType = 'html';
					this.baseURL = 'https://as.jivox.com/unit/layout_renderer.php?creativeUnitType=22&bDim=300x600&bUnitId=2200&siteId=25aba9801a0f01&campaignId=119189&es_pId=5sYhcJ&isDynamic=1&jvxVer=2&cMacro=https%3A%2F%2Fgoogleads.g.doubleclick.net%2Fdbm%2Fclk%3Fsa%3DL%26ai%3DCOdttmwJQW7fVJNHriQOTh7LwDeus-M1SzPbIotcGsqf9_4YNEAEgg_3mH2DJltGGgICgGcgBCagDAaoEwQFP0PeXX6IezS8pASn5zVDVblHADzInIi4SRiU5VzWpvpNKL33VANIwdW8fkC0mwJFJLKitKZSibo5M2uu1vq0XrEzprMjDNy6_oawCuyo1u_lAt2aH7U7VmfvIGNrUoWhSU5LOnKy-2-WMiBi3In8ZfN0H1Tv5-yf6vaOn4fXhxrEQJelsekCHqIHB0cAFh9VCWVai0YAQWKPs1YzFkTJhfzmHXJy7judZ2u3Y7J7Mrz_0YzxgL4sgCEoYIjPfe0ZC4AQDkAYBoAZNgAf_zfhjqAeOzhuoB9XJG6gH2csbqAfPzBuoB6a-G6gHmM4b2AcA0ggHCIBhEAEYAPIIDmJpZGRlci10cnVzdHhfgAoEsBO-w_kE0BMA2BMD%26num%3D1%26cid%3DCAASEuRoSvDDeOhCHC9UI_9Fpge6ZA%26sig%3DAOD64_1Xd1_xtSNAfV8atf0RVK3C8VogrQ%26client%3Dca-pub-7350897138099958%26dbm_c%3DAKAmf-B7hlW_I_SYjNgjLNo5gwA4gzP1tPIU7uflYZaMz2I2_XZKog4W9rAturxWdR5DnHD-j63W%26dbm_d%3DAKAmf-AQJJp4XfnPWRGa7xNWSMWfv41em7aYOnV-i3OpfSNzFYnXYj2TlJ7Z0wrxvS0_CPnwMKjKfaqQ9-RJzoib_Sns5f-kf5_E56NgL6mAXfxAez64WgOaCzfmw0xwLv56oEAEiNfWi9BHjEhrzozXrQNPoQGb1Yx31NhRhmaI5Lh6Ysp90ugO6XyPeL5k-jqIEhTVwQCd49FlBzFI84M3VbFNRJJVfHFIwQp6MMCb_ESZn-5WtGc1163hkSeGpEJBXjrbbCjY7N_A_TmvbCWV9AaADtCAXnkHzKhjZEq-em9dFfO78cLO2oqUEYkI1KqA5GN-Z1oz-S35gKGpdjs1UdsoAjNAybiwc81v9OeNx7gKTeZTCP7KRKnXKmw9chgqkC-e-HSlSCH8s12cOVcgPhKeuOW70K0pm8RVq2hKRfRLnJ3qSIHVKiS0hmh2G7BM8iWTpH-E8DQ_8Xy9YQft-RJPCD8YQYzb69-sCgF0rf-SaU0cArJwURe_hRbM24a1b_HZ-xDF5xOZHSZocRneTHCwFsvPxw%26adurl%3D&r=1531970203600759&objectName=jvx_5b50bc951fc83';
											this.baseURL += '&jvxSessionId=1532017813.9528';
			...
			if(bestFitExpand) {
				...
				if(this.expansionHasLayout == 1) {
					this.expansionType = 'html';
										var adUnitIdStr = '';
										this.expansionURL = 'https://as.jivox.com/unit/layout_renderer.php?creativeUnitType=22&bDim=300x600&&siteId=25aba9801a0f01&campaignId=119189&es_pId=5sYhcJ&isDynamic=1&jvxVer=2&cMacro=https%3A%2F%2Fgoogleads.g.doubleclick.net%2Fdbm%2Fclk%3Fsa%3DL%26ai%3DCOdttmwJQW7fVJNHriQOTh7LwDeus-M1SzPbIotcGsqf9_4YNEAEgg_3mH2DJltGGgICgGcgBCagDAaoEwQFP0PeXX6IezS8pASn5zVDVblHADzInIi4SRiU5VzWpvpNKL33VANIwdW8fkC0mwJFJLKitKZSibo5M2uu1vq0XrEzprMjDNy6_oawCuyo1u_lAt2aH7U7VmfvIGNrUoWhSU5LOnKy-2-WMiBi3In8ZfN0H1Tv5-yf6vaOn4fXhxrEQJelsekCHqIHB0cAFh9VCWVai0YAQWKPs1YzFkTJhfzmHXJy7judZ2u3Y7J7Mrz_0YzxgL4sgCEoYIjPfe0ZC4AQDkAYBoAZNgAf_zfhjqAeOzhuoB9XJG6gH2csbqAfPzBuoB6a-G6gHmM4b2AcA0ggHCIBhEAEYAPIIDmJpZGRlci10cnVzdHhfgAoEsBO-w_kE0BMA2BMD%26num%3D1%26cid%3DCAASEuRoSvDDeOhCHC9UI_9Fpge6ZA%26sig%3DAOD64_1Xd1_xtSNAfV8atf0RVK3C8VogrQ%26client%3Dca-pub-7350897138099958%26dbm_c%3DAKAmf-B7hlW_I_SYjNgjLNo5gwA4gzP1tPIU7uflYZaMz2I2_XZKog4W9rAturxWdR5DnHD-j63W%26dbm_d%3DAKAmf-AQJJp4XfnPWRGa7xNWSMWfv41em7aYOnV-i3OpfSNzFYnXYj2TlJ7Z0wrxvS0_CPnwMKjKfaqQ9-RJzoib_Sns5f-kf5_E56NgL6mAXfxAez64WgOaCzfmw0xwLv56oEAEiNfWi9BHjEhrzozXrQNPoQGb1Yx31NhRhmaI5Lh6Ysp90ugO6XyPeL5k-jqIEhTVwQCd49FlBzFI84M3VbFNRJJVfHFIwQp6MMCb_ESZn-5WtGc1163hkSeGpEJBXjrbbCjY7N_A_TmvbCWV9AaADtCAXnkHzKhjZEq-em9dFfO78cLO2oqUEYkI1KqA5GN-Z1oz-S35gKGpdjs1UdsoAjNAybiwc81v9OeNx7gKTeZTCP7KRKnXKmw9chgqkC-e-HSlSCH8s12cOVcgPhKeuOW70K0pm8RVq2hKRfRLnJ3qSIHVKiS0hmh2G7BM8iWTpH-E8DQ_8Xy9YQft-RJPCD8YQYzb69-sCgF0rf-SaU0cArJwURe_hRbM24a1b_HZ-xDF5xOZHSZocRneTHCwFsvPxw%26adurl%3D&r=1531970203600759&objectName=jvx_5b50bc951fc83'+adUnitIdStr;
											this.expansionURL += '&jvxSessionId=1532017813.9528';
		...
		listenerCallback:function(event) {
			jvx_5b50bc951fc83.eventController(event); 
		},
...
var jvx_5b50bc951fc83 = new CreativeUnit("_5b50bc951fc83");
jvx_5b50bc951fc83.DYReportingKey = "";
jvx_5b50bc951fc83.DYSegmentName = "";
    jvx_5b50bc951fc83.init();
